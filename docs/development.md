...
Maintainer notes for working on skilleval itself. Author-facing usage lives in the [root README](../README.md) and [authoring.md](authoring.md). Releases: [releasing.md](releasing.md). Architecture: [adrs/003_npm-platform-binaries.md](adrs/003_npm-platform-binaries.md).
