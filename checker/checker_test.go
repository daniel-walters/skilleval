...
func TestCheckFixtures(t *testing.T) {
	tests := []struct {
		...
		{name: "pass-tool-calls-exit-code", wantPassed: true},
		{name: "pass-tool-calls-exit-retry", wantPassed: true},
		{name: "pass-tool-calls-order-excludes", wantPassed: true},
		...
		{name: "fail-tool-calls-exit-code", wantPassed: false, wantFailPath: []string{"toolCalls.order[0]"}},
		{name: "fail-tool-calls-order-excludes", wantPassed: false, wantFailPath: []string{"toolCalls.orderExcludes[0]"}},
		{name: "fail-tool-calls-order-excludes-unknown", wantPassed: false, wantFailPath: []string{"toolCalls.orderExcludes[0]"}},
		{name: "fail-tool-calls-order-excludes-independent", wantPassed: false, wantFailPath: []string{"toolCalls.orderExcludes[1]"}},
		{
			name:         "fail-usage",
			wantPassed:   false,
